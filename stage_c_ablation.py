...
class AblatedHFModel:
    ...
    def set_erasers(self, erasers):
        ...
        Note: LEACE strength-1 IS the full linear removal -- there is no meaningful 'dose' (overshoot only
        distorts toward anti-concept, a confound), so the hook applies the eraser at unit strength."""
        import torch
        self.clear_ablation()
        self._erasers = {}
